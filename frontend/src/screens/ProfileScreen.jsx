      ...
      <Col md={3}>
        ...
        <Form onSubmit={submitHandler}>
          ...
          <Form.Group controlId="password" className="my-2">
            <Form.Label>Lozinka (prazno = bez izmene)</Form.Label>
          ...
          <Button type="submit" variant="primary" className="mt-2">Ažuriraj</Button>
      ...
      <Col md={9}>
        ...
        {isLoading ? (
          ...
          <Table striped hover responsive className="table-sm">
            <thead>
              <tr>
                <th>ID</th><th>DATUM</th><th>UKUPNO</th><th>PLAĆENO</th><th>ISPORUČENO</th><th></th>
              </tr>
            </thead>
            <tbody>
              {orders.map((order) => (
